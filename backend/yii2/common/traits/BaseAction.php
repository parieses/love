...
trait BaseAction
{
    ...
    public $headers;
    //设置免验证来源
    public $noCheckAction = ['love-frontend' => ['', 'site/synopsis', 'site/image'], 'love-backend' => ['', 'site/synopsis']];
    ...
    public function init()
    {
        ...
        $source = in_array($current_route, $this->noCheckAction[Yii::$app->id]) ? 'PC' : $this->headers['source'];
        if (!$source) {
